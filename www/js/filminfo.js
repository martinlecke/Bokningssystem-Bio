  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="row">
        ...
        <iframe class="col-12" id="trailer" width="560" height="315" src="https://www.youtube.com/embed/${app.movie[6].youtubeTrailers}"
        ...
        <div class="modal-body">
          <div class="row mx-1 item-parent">
            ...
            <div class="col-12 col-md-8 mb-3 item2">
              ...
              <h1>${app.movie[6].title}</h1>
              <p>${app.movie[6].description}</p>
                    ...
                    <a href="#" class="text-dark">
                      ...
                      <div>
                        ...
                        <span class="ml-5 float-right">
                          <button type="button" class="btn btn-danger font-weight-bold" data-toggle="modal" data-target="#film-info">
                            Boka
                          </button>
                        </span>
                      </div>
